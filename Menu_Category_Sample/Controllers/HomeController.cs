...
namespace Menu_Category_Sample.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult TempData()
        {
            ...
            var testItem = new CategoryItem("موبایل", "https://bugeto.net/");
            Products.Add(testItem);
            Products.Add(new CategoryItem("لپ تاپ", "https://bugeto.net/"));
            Products.Add(new CategoryItem("لوازم جانبی", "https://bugeto.net/"));
            Products.Add(new CategoryItem("کتاب", "https://bugeto.net/"));
